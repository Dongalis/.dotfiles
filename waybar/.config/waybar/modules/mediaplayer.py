...
class PlayerManager:
    ...
    def write_output(self, text, player):
        ...
        output = {"text": text,
                  ...
                  "tooltip": player.props.player_name.capitalize() + " volume: " + str(int(player.props.volume * 100)) + "%"}
    ...
    def on_volume_changed(self, player, volume, _=None):
        logger.debug(f"Volume changed for player {player.props.player_name}: {volume}")
        self.on_metadata_changed(player, player.props.metadata)
